layui.config({
    base: "/AdmianInter/page/links/js/"
        ...
        if ($checkbox.is(":checked")) {
            layer.confirm('确定删除选中的信息？', { icon: 3, title: '提示信息' }, function (index) {
                ...
                setTimeout(function () {
                    ...
                    //删除数据
                    $.ajax({
                        url: "/UserMvc/CarTypesDel?id=" + ids,
                        type: "get",
                        dataType: "json",
                        success: function (data) {
                            //执行加载数据的方法
    ...
    $("body").on("click", ".links_edit", function () {  //编辑
        layer.alert('/UserMvc/StallUpdate?id=' + data - id, { icon: 6, title: '友链编辑' });
    })
    ...
    $("body").on("click", ".links_del", function () {  //删除
        ...
        layer.confirm('确定删除此信息？', { icon: 3, title: '提示信息' }, function (index) {
            ...
            $.ajax({
                url: "/UserMvc/CarTypesDel?id=" + _this.attr("data-id"),
                type: "get",
                dataType: "json",
                success: function (data) {
                    layer.msg("删除成功");
